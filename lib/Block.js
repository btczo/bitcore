...
Block.getDGBSubsidy = function getDGBSubsidy(height) {
    var subsidy = 1 * util.COIN;

    if (height < 400000) {
        subsidy = 8000 * util.COIN;
...
Block.getBlockValue = function getBlockValue(height) {
    ...
    if (height < 67200) {
        ...
        if (height < 1440) {
            subsidy = 72000 * util.COIN;
        } else if (height < 5760) {
            subsidy = 16000 * util.COIN;
        }
    } else {
        subsidy = Block.getDGBSubsidy(height);
    }

    if (subsidy < 1 * util.COIN) {
        subsidy = 1 * util.COIN;
    }
