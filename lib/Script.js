...
var TX_SCRIPTHASH = 4;
var TX_RETURN = 5;
var TX_WITNESSPUBKEYHASH = 6;
var TX_WITNESSSCRIPTHASH = 7;
...
Script.TX_WITNESSPUBKEYHASH = TX_WITNESSPUBKEYHASH;
Script.TX_WITNESSSCRIPTHASH = TX_WITNESSSCRIPTHASH;
...
Script.prototype.isWitnessPubKeyHash = function() {
  return (this.buffer.length === 22 &&
    this.buffer[0] == Opcode.map.OP_0 &&
    this.buffer[1] === 0x14);
};

Script.prototype.isWitnessScriptHash = function() {
  return (this.buffer.length === 34 &&
    this.buffer[0] == Opcode.map.OP_0 &&
    this.buffer[1] === 0x20);
}
...
Script.prototype.classify = function() {
  if (this.isWitnessPubKeyHash())
    return TX_WITNESSPUBKEYHASH;
  if (this.isWitnessScriptHash())
    return TX_WITNESSSCRIPTHASH;
...
Script.prototype.capture = function() {
  ...
  switch (txType) {
    ...
    case TX_SCRIPTHASH:
      ...
      break;
    case TX_WITNESSPUBKEYHASH:
      res.push(this.chunks[1]);
      break;
    case TX_WITNESSSCRIPTHASH:
      res.push(this.chunks[1]);
      break;
