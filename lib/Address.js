...
Address.fromScript = function(script, network) {
  ...
  var version = networks[network].P2SHVersionTwo;
  ...
  if (payload) {
    ...
    switch (txType) {
      case Script.TX_PUBKEY:
        ...
        break;
      case Script.TX_WITNESSPUBKEYHASH:
        bech32 = true;
        version = networks[network].addressVersion;
        break;
      ...
      case Script.TX_MULTISIG:
        ...
        break;
      case Script.TX_WITNESSSCRIPTHASH:
        bech32 = true;
        version = networks[network].P2SHVersionTwo;
        break;
    ...
    for (var i in payload){
      ret.push(new Address(version, payload[i], bech32));
    }
  }
  return ret;
};
...
Address.prototype.network = function() {
  ...
  var answer;
  if (version === livenet.addressVersion || version === livenet.P2SHVersion || version === livenet.P2SHVersionTwo )
    answer = livenet;
...
Address.prototype.isScript = function() {
  return this.isValid() && (this.version() === this.network().P2SHVersion || this.version() === this.network().P2SHVersionTwo);
};
...
Address.prototype.getScriptPubKey = function() {
  ...
  else if (version === livenet.P2SHVersion || version === testnet.P2SHVersion || version === livenet.P2SHVersionTwo)
